...
type Props<I,C,T> = {
  ...
  height: any;
  zIndex: number;
  makeDragHandleProps: (getY: () => number) => any;
  commonProps: C;
};
export default class MoveContainer<I,C,T extends React.ComponentType<any>> extends React.Component<Props<I,C,T>> {
  _templateContainer: TemplateContainer<I,C,T>;
  _templateContainerSetter = (cmp?: any) => {
